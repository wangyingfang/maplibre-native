...
val presetFilters = listOf(
    ...
    PresetFilter("2. 只隐藏地势", "!hillShading,"),
    PresetFilter("3. 显示标签并隐藏道路，道路编号，水域，地势，界线", "!default,waterName,continentName,countryRegionName,islandName,cityName,roadName,"),
    PresetFilter("4. 隐藏地势和水域", "!hillShading,!water,"),
    ...
    PresetFilter("18.陆地空白色且显示水域形状,水域名,界线", "!default,water,waterName,countryRegion,"),
    PresetFilter("19.陆地空白色且显示水域形状,界线,道路,隐藏铁路", "!default,water,countryRegion,road,!railway,"),
    PresetFilter("20.陆地空白色且隐藏地势,道路编号,路名,道路,绿地", "!land,!reserve,!hillShading,!roadName,!roadShield,"),
    PresetFilter("21.显示未包含地势和绿地的底图,岛屿名", "!default,land,base,!reserve,islandName,"),
    PresetFilter("22.显示未包含地势的底图,城市名,水域名,岛屿名", "!default,land,base,!reserve,waterName,islandName,cityName,!townName,!villageName,"),
)
